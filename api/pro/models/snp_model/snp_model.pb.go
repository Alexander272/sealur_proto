...
type SnpData struct {
	...
	Materials   []*snp_material_model.SnpMaterial `protobuf:"bytes,2,rep,name=materials,proto3" json:"materials,omitempty"`
...
func (x *SnpData) GetMaterials() []*snp_material_model.SnpMaterial {
	if x != nil {
		return x.Materials
	}
	return nil
...
type SnpDataNew struct {
	...
	Materials   []*snp_material_model.SnpMaterial `protobuf:"bytes,2,rep,name=materials,proto3" json:"materials,omitempty"`
	Mounting    []*mounting_model.Mounting        `protobuf:"bytes,3,rep,name=mounting,proto3" json:"mounting,omitempty"`
	Fillers     []*snp_filler_model.SnpFillerNew  `protobuf:"bytes,4,rep,name=fillers,proto3" json:"fillers,omitempty"`
	// TODO
	SnpMaterials *snp_material_model.SnpMaterials `protobuf:"bytes,5,opt,name=snpMaterials,proto3" json:"snpMaterials,omitempty"`
}

func (x *SnpDataNew) Reset() {
	*x = SnpDataNew{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pro_models_snp_model_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SnpDataNew) Descriptor() ([]byte, []int) {
	return file_pro_models_snp_model_proto_rawDescGZIP(), []int{2}
}

func (x *SnpDataNew) GetFlangeTypes() []*FlangeType {
	if x != nil {
		return x.FlangeTypes
	}
	return nil
...
func (x *SnpDataNew) GetMaterials() []*snp_material_model.SnpMaterial {
	if x != nil {
		return x.Materials
	}
	return nil
...
func (x *SnpDataNew) GetMounting() []*mounting_model.Mounting {
	if x != nil {
		return x.Mounting
	}
	return nil
...
func (x *SnpDataNew) GetFillers() []*snp_filler_model.SnpFillerNew {
	if x != nil {
		return x.Fillers
	}
	return nil
...
func (x *SnpDataNew) GetSnpMaterials() *snp_material_model.SnpMaterials {
	if x != nil {
		return x.SnpMaterials
	}
	return nil
}
...
var file_pro_models_snp_model_proto_rawDesc = []byte{
	...
	0x54, 0x79, 0x70, 0x65, 0x52, 0x05, 0x74, 0x79, 0x70, 0x65, 0x73, 0x22, 0xee, 0x01, 0x0a, 0x07,
	...
	0x12, 0x3d, 0x0a, 0x09, 0x6d, 0x61, 0x74, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x73, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x73, 0x6e, 0x70, 0x5f, 0x6d, 0x61, 0x74, 0x65, 0x72, 0x69,
	...
	,
	...
	0x2f, 0x73, 0x6e, 0x70, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_pro_models_snp_model_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pro_models_snp_model_proto_goTypes = []interface{}{
	...
	(*SnpDataNew)(nil),                      // 2: snp_model.SnpDataNew
	(*snp_type_model.SnpType)(nil),          // 3: snp_type_model.SnpType
	(*snp_material_model.SnpMaterial)(nil),  // 4: snp_material_model.SnpMaterial
	(*mounting_model.Mounting)(nil),         // 5: mounting_model.Mounting
	(*snp_filler_model.SnpFiller)(nil),      // 6: snp_filler_model.SnpFiller
	(*snp_filler_model.SnpFillerNew)(nil),   // 7: snp_filler_model.SnpFillerNew
	(*snp_material_model.SnpMaterials)(nil), // 8: snp_material_model.SnpMaterials
}
var file_pro_models_snp_model_proto_depIdxs = []int32{
	3,  // 0: snp_model.FlangeType.types:type_name -> snp_type_model.SnpType
	0,  // 1: snp_model.SnpData.flangeTypes:type_name -> snp_model.FlangeType
	4,  // 2: snp_model.SnpData.materials:type_name -> snp_material_model.SnpMaterial
	5,  // 3: snp_model.SnpData.mounting:type_name -> mounting_model.Mounting
	6,  // 4: snp_model.SnpData.fillers:type_name -> snp_filler_model.SnpFiller
	0,  // 5: snp_model.SnpDataNew.flangeTypes:type_name -> snp_model.FlangeType
	4,  // 6: snp_model.SnpDataNew.materials:type_name -> snp_material_model.SnpMaterial
	5,  // 7: snp_model.SnpDataNew.mounting:type_name -> mounting_model.Mounting
	7,  // 8: snp_model.SnpDataNew.fillers:type_name -> snp_filler_model.SnpFillerNew
	8,  // 9: snp_model.SnpDataNew.snpMaterials:type_name -> snp_material_model.SnpMaterials
...
func file_pro_models_snp_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pro_models_snp_model_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
