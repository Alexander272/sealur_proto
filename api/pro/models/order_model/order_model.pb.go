...
var file_pro_models_order_model_proto_goTypes = []interface{}{
	(*Order)(nil),                        // 0: order_model.Order
	(*FullOrder)(nil),                    // 1: order_model.FullOrder
	(*CurrentOrder)(nil),                 // 2: order_model.CurrentOrder
...
var file_pro_models_order_model_proto_depIdxs = []int32{
	3, // 0: order_model.Order.positions:type_name -> position_model.Position
	4, // 1: order_model.FullOrder.positions:type_name -> position_model.FullPosition
	5, // 2: order_model.CurrentOrder.positions:type_name -> position_model.OrderPosition
