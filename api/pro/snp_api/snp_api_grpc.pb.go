...
const (
	SnpDataService_Get_FullMethodName     = "/snp_api.SnpDataService/Get"
	SnpDataService_GetData_FullMethodName = "/snp_api.SnpDataService/GetData"
)
...
func (c *snpDataServiceClient) GetData(ctx context.Context, in *GetSnpData, opts ...grpc.CallOption) (*SnpData, error) {
	out := new(SnpData)
	err := c.cc.Invoke(ctx, SnpDataService_GetData_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SnpDataService_GetData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SnpDataService_GetData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
