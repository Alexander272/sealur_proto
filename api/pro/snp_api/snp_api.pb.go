...
type Snp struct {
	...
	// size
	Sizes *snp_size_model.SnpSize `protobuf:"bytes,2,opt,name=sizes,proto3" json:"sizes,omitempty"`
}
...
var file_pro_snp_api_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x73, 0x69, 0x7a, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e,
