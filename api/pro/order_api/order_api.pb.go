...
var file_pro_order_api_proto_rawDesc = []byte{
	...
	0x87, 0x01, 0x0a, 0x0b, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12,
	...
	0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x1d, 0x0a, 0x0b, 0x44, 0x65, 0x6c,
	0x65, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x34, 0x0a, 0x06, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x73, 0x12, 0x2a, 0x0a, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c,
	0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x22, 0x43,
	...
	0x28, 0x03, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x32, 0xaf, 0x03, 0x0a, 0x0c, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x32, 0x0a, 0x03, 0x47,
	0x65, 0x74, 0x12, 0x13, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x61, 0x70, 0x69, 0x2e, 0x47,
	0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x1a, 0x16, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x36, 0x0a, 0x04, 0x53, 0x61,
...
var file_pro_order_api_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_pro_order_api_proto_goTypes = []interface{}{
	...
	(*CreateOrder)(nil),                 // 3: order_api.CreateOrder
	(*DeleteOrder)(nil),                 // 4: order_api.DeleteOrder
	(*Orders)(nil),                      // 5: order_api.Orders
	(*Positions)(nil),                   // 6: order_api.Positions
	(*OrderNumber)(nil),                 // 7: order_api.OrderNumber
	(*position_model.FullPosition)(nil), // 8: position_model.FullPosition
	(*order_model.Order)(nil),           // 9: order_model.Order
	(*position_model.Position)(nil),     // 10: position_model.Position
	(*order_model.FullOrder)(nil),       // 11: order_model.FullOrder
	(*order_model.CurrentOrder)(nil),    // 12: order_model.CurrentOrder
	(*response_model.FileResponse)(nil), // 13: response_model.FileResponse
...
var file_pro_order_api_proto_depIdxs = []int32{
	8,  // 0: order_api.CreateOrder.positions:type_name -> position_model.FullPosition
	9,  // 1: order_api.Orders.orders:type_name -> order_model.Order
	10, // 2: order_api.Positions.positions:type_name -> position_model.Position
	0,  // 3: order_api.OrderService.Get:input_type -> order_api.GetOrder
	1,  // 4: order_api.OrderService.GetCurrent:input_type -> order_api.GetCurrentOrder
	2,  // 5: order_api.OrderService.GetAll:input_type -> order_api.GetAllOrders
	0,  // 6: order_api.OrderService.GetFile:input_type -> order_api.GetOrder
	3,  // 7: order_api.OrderService.Save:input_type -> order_api.CreateOrder
	3,  // 8: order_api.OrderService.Create:input_type -> order_api.CreateOrder
	4,  // 9: order_api.OrderService.Delete:input_type -> order_api.DeleteOrder
	11, // 10: order_api.OrderService.Get:output_type -> order_model.FullOrder
	12, // 11: order_api.OrderService.GetCurrent:output_type -> order_model.CurrentOrder
	5,  // 12: order_api.OrderService.GetAll:output_type -> order_api.Orders
	13, // 13: order_api.OrderService.GetFile:output_type -> response_model.FileResponse
	7,  // 14: order_api.OrderService.Save:output_type -> order_api.OrderNumber
	14, // 15: order_api.OrderService.Create:output_type -> response_model.IdResponse
	15, // 16: order_api.OrderService.Delete:output_type -> response_model.Response
