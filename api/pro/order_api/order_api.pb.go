...
func (x *CopyOrder) GetCount() string {
	if x != nil {
		return x.Count
	}
	return ""
...
var file_pro_order_api_proto_rawDesc = []byte{
	...
	0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x5e, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12,
	...
	0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x2f, 0x0a, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x2e, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52,
	0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x22, 0x34, 0x0a, 0x06, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73,
	0x12, 0x2a, 0x0a, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x12, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x52, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x22, 0x43, 0x0a, 0x09,
	...
	0x72, 0x64, 0x65, 0x72, 0x52, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x32, 0xeb, 0x04, 0x0a,
	...
	0x65, 0x72, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x12, 0x46, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x41,
	0x6c, 0x6c, 0x4f, 0x70, 0x65, 0x6e, 0x12, 0x1e, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x61,
	0x70, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72,
...
var file_pro_order_api_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_pro_order_api_proto_goTypes = []interface{}{
	...
	(*Order)(nil),                       // 8: order_api.Order
	(*Orders)(nil),                      // 9: order_api.Orders
	(*Positions)(nil),                   // 10: order_api.Positions
	(*OrderNumber)(nil),                 // 11: order_api.OrderNumber
	(*ManagerOrders)(nil),               // 12: order_api.ManagerOrders
	(*position_model.FullPosition)(nil), // 13: position_model.FullPosition
	(*user_model.User)(nil),             // 14: user_model.User
	(*order_model.CurrentOrder)(nil),    // 15: order_model.CurrentOrder
	(*order_model.Order)(nil),           // 16: order_model.Order
	(*position_model.Position)(nil),     // 17: position_model.Position
	(*order_model.ManagerOrder)(nil),    // 18: order_model.ManagerOrder
	(*response_model.FileResponse)(nil), // 19: response_model.FileResponse
...
var file_pro_order_api_proto_depIdxs = []int32{
	13, // 0: order_api.CreateOrder.positions:type_name -> position_model.FullPosition
	14, // 1: order_api.Order.user:type_name -> user_model.User
	15, // 2: order_api.Order.order:type_name -> order_model.CurrentOrder
	16, // 3: order_api.Orders.orders:type_name -> order_model.Order
	17, // 4: order_api.Positions.positions:type_name -> position_model.Position
	18, // 5: order_api.ManagerOrders.orders:type_name -> order_model.ManagerOrder
	0,  // 6: order_api.OrderService.Get:input_type -> order_api.GetOrder
	1,  // 7: order_api.OrderService.GetCurrent:input_type -> order_api.GetCurrentOrder
	2,  // 8: order_api.OrderService.GetAll:input_type -> order_api.GetAllOrders
	0,  // 9: order_api.OrderService.GetFile:input_type -> order_api.GetOrder
	3,  // 10: order_api.OrderService.GetOpen:input_type -> order_api.GetManagerOrders
	4,  // 11: order_api.OrderService.GetAllOpen:input_type -> order_api.GetAllManagerOrders
	5,  // 12: order_api.OrderService.Save:input_type -> order_api.CreateOrder
	5,  // 13: order_api.OrderService.Create:input_type -> order_api.CreateOrder
	7,  // 14: order_api.OrderService.Copy:input_type -> order_api.CopyOrder
	6,  // 15: order_api.OrderService.Delete:input_type -> order_api.DeleteOrder
	8,  // 16: order_api.OrderService.Get:output_type -> order_api.Order
	15, // 17: order_api.OrderService.GetCurrent:output_type -> order_model.CurrentOrder
	9,  // 18: order_api.OrderService.GetAll:output_type -> order_api.Orders
	19, // 19: order_api.OrderService.GetFile:output_type -> response_model.FileResponse
	12, // 20: order_api.OrderService.GetOpen:output_type -> order_api.ManagerOrders
	12, // 21: order_api.OrderService.GetAllOpen:output_type -> order_api.ManagerOrders
	11, // 22: order_api.OrderService.Save:output_type -> order_api.OrderNumber
	20, // 23: order_api.OrderService.Create:output_type -> response_model.IdResponse
	21, // 24: order_api.OrderService.Copy:output_type -> response_model.Response
	21, // 25: order_api.OrderService.Delete:output_type -> response_model.Response
