...
var file_pro_order_api_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x65, 0x72, 0x73, 0x32, 0xb3, 0x04, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53,
	...
	0x3a, 0x0a, 0x06, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x16, 0x2e, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x5f, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x1a, 0x18, 0x2e, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x5f, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x13, 0x5a, 0x11, 0x61,
	0x70, 0x69, 0x2f, 0x70, 0x72, 0x6f, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x61, 0x70, 0x69,
...
var file_pro_order_api_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_pro_order_api_proto_goTypes = []interface{}{
	...
	(*Order)(nil),                       // 7: order_api.Order
	(*Orders)(nil),                      // 8: order_api.Orders
	(*Positions)(nil),                   // 9: order_api.Positions
	(*OrderNumber)(nil),                 // 10: order_api.OrderNumber
	(*ManagerOrders)(nil),               // 11: order_api.ManagerOrders
	(*position_model.FullPosition)(nil), // 12: position_model.FullPosition
	(*user_model.User)(nil),             // 13: user_model.User
	(*order_model.CurrentOrder)(nil),    // 14: order_model.CurrentOrder
	(*order_model.Order)(nil),           // 15: order_model.Order
	(*position_model.Position)(nil),     // 16: position_model.Position
	(*order_model.ManagerOrder)(nil),    // 17: order_model.ManagerOrder
	(*response_model.FileResponse)(nil), // 18: response_model.FileResponse
	(*response_model.IdResponse)(nil),   // 19: response_model.IdResponse
	(*response_model.Response)(nil),     // 20: response_model.Response
}
var file_pro_order_api_proto_depIdxs = []int32{
	12, // 0: order_api.CreateOrder.positions:type_name -> position_model.FullPosition
	13, // 1: order_api.Order.user:type_name -> user_model.User
	14, // 2: order_api.Order.order:type_name -> order_model.CurrentOrder
	15, // 3: order_api.Orders.orders:type_name -> order_model.Order
	16, // 4: order_api.Positions.positions:type_name -> position_model.Position
	17, // 5: order_api.ManagerOrders.orders:type_name -> order_model.ManagerOrder
	...
	6,  // 14: order_api.OrderService.Delete:input_type -> order_api.DeleteOrder
	7,  // 15: order_api.OrderService.Get:output_type -> order_api.Order
	14, // 16: order_api.OrderService.GetCurrent:output_type -> order_model.CurrentOrder
	8,  // 17: order_api.OrderService.GetAll:output_type -> order_api.Orders
	18, // 18: order_api.OrderService.GetFile:output_type -> response_model.FileResponse
	11, // 19: order_api.OrderService.GetOpen:output_type -> order_api.ManagerOrders
	11, // 20: order_api.OrderService.GetAllOpen:output_type -> order_api.ManagerOrders
	10, // 21: order_api.OrderService.Save:output_type -> order_api.OrderNumber
	19, // 22: order_api.OrderService.Create:output_type -> response_model.IdResponse
	20, // 23: order_api.OrderService.Delete:output_type -> response_model.Response
