...
const (
	PutgSizeService_Get_FullMethodName           = "/putg_size_api.PutgSizeService/Get"
	PutgSizeService_GetNew_FullMethodName        = "/putg_size_api.PutgSizeService/GetNew"
	PutgSizeService_Create_FullMethodName        = "/putg_size_api.PutgSizeService/Create"
	PutgSizeService_CreateSeveral_FullMethodName = "/putg_size_api.PutgSizeService/CreateSeveral"
	PutgSizeService_Update_FullMethodName        = "/putg_size_api.PutgSizeService/Update"
	PutgSizeService_Delete_FullMethodName        = "/putg_size_api.PutgSizeService/Delete"
)
...
func (c *putgSizeServiceClient) Get(ctx context.Context, in *GetPutgSize, opts ...grpc.CallOption) (*PutgSize, error) {
	out := new(PutgSize)
	err := c.cc.Invoke(ctx, PutgSizeService_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *putgSizeServiceClient) GetNew(ctx context.Context, in *GetPutgSize_New, opts ...grpc.CallOption) (*PutgSize, error) {
	out := new(PutgSize)
	err := c.cc.Invoke(ctx, PutgSizeService_GetNew_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *putgSizeServiceClient) Create(ctx context.Context, in *CreatePutgSize, opts ...grpc.CallOption) (*response_model.Response, error) {
	...
	err := c.cc.Invoke(ctx, PutgSizeService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *putgSizeServiceClient) CreateSeveral(ctx context.Context, in *CreateSeveralPutgSize, opts ...grpc.CallOption) (*response_model.Response, error) {
	out := new(response_model.Response)
	err := c.cc.Invoke(ctx, PutgSizeService_CreateSeveral_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *putgSizeServiceClient) Update(ctx context.Context, in *UpdatePutgSize, opts ...grpc.CallOption) (*response_model.Response, error) {
	out := new(response_model.Response)
	err := c.cc.Invoke(ctx, PutgSizeService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *putgSizeServiceClient) Delete(ctx context.Context, in *DeletePutgSize, opts ...grpc.CallOption) (*response_model.Response, error) {
	out := new(response_model.Response)
	err := c.cc.Invoke(ctx, PutgSizeService_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PutgSizeService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PutgSizeService_Get_FullMethodName,
	}
...
func _PutgSizeService_GetNew_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PutgSizeService_GetNew_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PutgSizeService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PutgSizeService_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PutgSizeService_CreateSeveral_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PutgSizeService_CreateSeveral_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PutgSizeService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PutgSizeService_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PutgSizeService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PutgSizeService_Delete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
