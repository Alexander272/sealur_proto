...
type RingModifying struct {
	...
	Modifying *ring_modifying_model.RingModifying `protobuf:"bytes,1,opt,name=modifying,proto3" json:"modifying,omitempty"`
}
...
var file_pro_ring_modifying_api_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x72, 0x69, 0x6e, 0x67, 0x5f, 0x6d, 0x6f, 0x64, 0x69, 0x66,
