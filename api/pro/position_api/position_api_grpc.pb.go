...
const (
	PositionService_Create_FullMethodName = "/position_api.PositionService/Create"
	PositionService_Update_FullMethodName = "/position_api.PositionService/Update"
	PositionService_Copy_FullMethodName   = "/position_api.PositionService/Copy"
	PositionService_Delete_FullMethodName = "/position_api.PositionService/Delete"
)
...
func (c *positionServiceClient) Copy(ctx context.Context, in *CopyPosition, opts ...grpc.CallOption) (*CopyDrawing, error) {
	out := new(CopyDrawing)
	err := c.cc.Invoke(ctx, PositionService_Copy_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PositionService_Copy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PositionService_Copy_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
