...
var file_moment_api_moment_proto_rawDesc = []byte{
	...
	0x6e, 0x67, 0x74, 0x68, 0x10, 0x01, 0x22, 0xc3, 0x01, 0x0a, 0x09, 0x43, 0x61, 0x70, 0x52, 0x65,
	...
	0x28, 0x09, 0x52, 0x08, 0x6d, 0x61, 0x74, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x22, 0xd5, 0x02, 0x0a,
	...
	0x6d, 0x62, 0x65, 0x64, 0x12, 0x2a, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6d, 0x6f, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x61, 0x70, 0x69, 0x2e,
...
var file_moment_api_moment_proto_msgTypes = make([]protoimpl.MessageInfo, 127)
var file_moment_api_moment_proto_goTypes = []interface{}{
	...
	(*CapResponse)(nil),                      // 124: moment_api.CapResponse
	(*GetFlangeRequest)(nil),                 // 125: moment_api.GetFlangeRequest
	(*GetFlangeResponse)(nil),                // 126: moment_api.GetFlangeResponse
	(*MaterialsDataResponse_Voltage)(nil),    // 127: moment_api.MaterialsDataResponse.Voltage
	(*MaterialsDataResponse_Elasticity)(nil), // 128: moment_api.MaterialsDataResponse.Elasticity
	(*MaterialsDataResponse_Alpha)(nil),      // 129: moment_api.MaterialsDataResponse.Alpha
	(*CreateManyEnvDataRequest_Data)(nil),    // 130: moment_api.CreateManyEnvDataRequest.Data
	(*CreateManyGasketDataRequest_Data)(nil), // 131: moment_api.CreateManyGasketDataRequest.Data
	(*FlangeData_Size)(nil),                  // 132: moment_api.FlangeData.Size
	(*GasketData_Data)(nil),                  // 133: moment_api.GasketData.Data
	(*CalcFormulas_StrengthF)(nil),           // 134: moment_api.CalcFormulas.StrengthF
	(*CalcFormulas_Flange)(nil),              // 135: moment_api.CalcFormulas.Flange
	(*CalcFormulas_Strength)(nil),            // 136: moment_api.CalcFormulas.Strength
	(*CalcFormulas_Basis)(nil),               // 137: moment_api.CalcFormulas.Basis
}
var file_moment_api_moment_proto_depIdxs = []int32{
	...
	127, // 2: moment_api.MaterialsDataResponse.voltage:type_name -> moment_api.MaterialsDataResponse.Voltage
	128, // 3: moment_api.MaterialsDataResponse.elasticity:type_name -> moment_api.MaterialsDataResponse.Elasticity
	129, // 4: moment_api.MaterialsDataResponse.alpha:type_name -> moment_api.MaterialsDataResponse.Alpha
	...
	130, // 12: moment_api.CreateManyEnvDataRequest.data:type_name -> moment_api.CreateManyEnvDataRequest.Data
	131, // 13: moment_api.CreateManyGasketDataRequest.data:type_name -> moment_api.CreateManyGasketDataRequest.Data
	...
	132, // 30: moment_api.FlangeData.size:type_name -> moment_api.FlangeData.Size
	...
	133, // 35: moment_api.GasketData.data:type_name -> moment_api.GasketData.Data
	...
	137, // 49: moment_api.CalcFormulas.basis:type_name -> moment_api.CalcFormulas.Basis
	136, // 50: moment_api.CalcFormulas.strength:type_name -> moment_api.CalcFormulas.Strength
	...
	110, // 71: moment_api.CapResponse.flange:type_name -> moment_api.FlangeResult
	123, // 72: moment_api.CapResponse.cap:type_name -> moment_api.CapResult
	111, // 73: moment_api.CapResponse.bolt:type_name -> moment_api.BoltResult
	112, // 74: moment_api.CapResponse.gasket:type_name -> moment_api.GasketResult
	113, // 75: moment_api.CapResponse.embed:type_name -> moment_api.EmbedResult
	109, // 76: moment_api.CapResponse.data:type_name -> moment_api.DataResult
	114, // 77: moment_api.CapResponse.washers:type_name -> moment_api.WasherResult
	81,  // 78: moment_api.GetFlangeResponse.typeFlange:type_name -> moment_api.TypeFlange
	87,  // 79: moment_api.GetFlangeResponse.standarts:type_name -> moment_api.StandartWithSize
	38,  // 80: moment_api.GetFlangeResponse.gaskets:type_name -> moment_api.GasketWithThick
	51,  // 81: moment_api.GetFlangeResponse.env:type_name -> moment_api.Env
	15,  // 82: moment_api.GetFlangeResponse.materials:type_name -> moment_api.Material
	1,   // 83: moment_api.GasketData.Data.type:type_name -> moment_api.GasketData.Type
	134, // 84: moment_api.CalcFormulas.Strength.strength:type_name -> moment_api.CalcFormulas.StrengthF
	135, // 85: moment_api.CalcFormulas.Strength.flange:type_name -> moment_api.CalcFormulas.Flange
	11,  // 86: moment_api.PingService.Ping:input_type -> moment_api.PingRequest
	17,  // 87: moment_api.MaterialsService.GetMaterials:input_type -> moment_api.GetMaterialsRequest
	23,  // 88: moment_api.MaterialsService.GetMaterialsData:input_type -> moment_api.GetMaterialsDataRequest
	17,  // 89: moment_api.MaterialsService.GetMaterialsWithIsEmpty:input_type -> moment_api.GetMaterialsRequest
	18,  // 90: moment_api.MaterialsService.CreateMaterial:input_type -> moment_api.CreateMaterialRequest
	19,  // 91: moment_api.MaterialsService.UpdateMaterial:input_type -> moment_api.UpdateMaterialRequest
	20,  // 92: moment_api.MaterialsService.DeleteMaterial:input_type -> moment_api.DeleteMaterialRequest
	26,  // 93: moment_api.MaterialsService.CreateVoltage:input_type -> moment_api.CreateVoltageRequest
	27,  // 94: moment_api.MaterialsService.UpdateVoltage:input_type -> moment_api.UpdateVoltageRequest
	28,  // 95: moment_api.MaterialsService.DeleteVoltage:input_type -> moment_api.DeleteVoltageRequest
	30,  // 96: moment_api.MaterialsService.CreateElasticity:input_type -> moment_api.CreateElasticityRequest
	31,  // 97: moment_api.MaterialsService.UpdateElasticity:input_type -> moment_api.UpdateElasticityRequest
	32,  // 98: moment_api.MaterialsService.DeleteElasticity:input_type -> moment_api.DeleteElasticityRequest
	34,  // 99: moment_api.MaterialsService.CreateAlpha:input_type -> moment_api.CreateAlphaRequest
	35,  // 100: moment_api.MaterialsService.UpdateAlpha:input_type -> moment_api.UpdateAlphaRequest
	36,  // 101: moment_api.MaterialsService.DeleteAlpha:input_type -> moment_api.DeleteAlphaRequest
	68,  // 102: moment_api.GasketService.GetFullData:input_type -> moment_api.GetFullDataRequest
	39,  // 103: moment_api.GasketService.GetGasket:input_type -> moment_api.GetGasketRequest
	39,  // 104: moment_api.GasketService.GetGasketWithThick:input_type -> moment_api.GetGasketRequest
	40,  // 105: moment_api.GasketService.CreateGasket:input_type -> moment_api.CreateGasketRequest
	41,  // 106: moment_api.GasketService.UpdateGasket:input_type -> moment_api.UpdateGasketRequest
	42,  // 107: moment_api.GasketService.DeleteGasket:input_type -> moment_api.DeleteGasketRequest
	46,  // 108: moment_api.GasketService.GetGasketType:input_type -> moment_api.GetGasketTypeRequest
	47,  // 109: moment_api.GasketService.CreateGasketType:input_type -> moment_api.CreateGasketTypeRequest
	48,  // 110: moment_api.GasketService.UpdateGasketType:input_type -> moment_api.UpdateGasketTypeRequest
	49,  // 111: moment_api.GasketService.DeleteGasketType:input_type -> moment_api.DeleteGasketTypeRequest
	52,  // 112: moment_api.GasketService.GetEnv:input_type -> moment_api.GetEnvRequest
	53,  // 113: moment_api.GasketService.CreateEnv:input_type -> moment_api.CreateEnvRequest
	54,  // 114: moment_api.GasketService.UpdateEnv:input_type -> moment_api.UpdateEnvRequest
	55,  // 115: moment_api.GasketService.DeleteEnv:input_type -> moment_api.DeleteEnvRequest
	57,  // 116: moment_api.GasketService.CreateManyEnvData:input_type -> moment_api.CreateManyEnvDataRequest
	58,  // 117: moment_api.GasketService.CreateEnvData:input_type -> moment_api.CreateEnvDataRequest
	59,  // 118: moment_api.GasketService.UpdateEnvData:input_type -> moment_api.UpdateEnvDataRequest
	60,  // 119: moment_api.GasketService.DeleteEnvData:input_type -> moment_api.DeleteEnvDataRequest
	61,  // 120: moment_api.GasketService.CreateManyGasketData:input_type -> moment_api.CreateManyGasketDataRequest
	62,  // 121: moment_api.GasketService.CreateGasketData:input_type -> moment_api.CreateGasketDataRequest
	64,  // 122: moment_api.GasketService.UpdateGasketTypeId:input_type -> moment_api.UpdateGasketTypeIdRequest
	63,  // 123: moment_api.GasketService.UpdateGasketData:input_type -> moment_api.UpdateGasketDataRequest
	65,  // 124: moment_api.GasketService.DeleteGasketData:input_type -> moment_api.DeleteGasketDataRequest
	70,  // 125: moment_api.FlangeService.GetBolts:input_type -> moment_api.GetBoltsRequest
	70,  // 126: moment_api.FlangeService.GetAllBolts:input_type -> moment_api.GetBoltsRequest
	71,  // 127: moment_api.FlangeService.CreateBolt:input_type -> moment_api.CreateBoltRequest
	72,  // 128: moment_api.FlangeService.CreateBolts:input_type -> moment_api.CreateBoltsRequest
	73,  // 129: moment_api.FlangeService.UpdateBolt:input_type -> moment_api.UpdateBoltRequest
	74,  // 130: moment_api.FlangeService.DeleteBolt:input_type -> moment_api.DeleteBoltRequest
	77,  // 131: moment_api.FlangeService.GetTypeFlange:input_type -> moment_api.GetTypeFlangeRequest
	78,  // 132: moment_api.FlangeService.CreateTypeFlange:input_type -> moment_api.CreateTypeFlangeRequest
	79,  // 133: moment_api.FlangeService.UpdateTypeFlange:input_type -> moment_api.UpdateTypeFlangeRequest
	80,  // 134: moment_api.FlangeService.DeleteTypeFlange:input_type -> moment_api.DeleteTypeFlangeRequest
	83,  // 135: moment_api.FlangeService.GetStandarts:input_type -> moment_api.GetStandartsRequest
	83,  // 136: moment_api.FlangeService.GetStandartsWithSize:input_type -> moment_api.GetStandartsRequest
	84,  // 137: moment_api.FlangeService.CreateStandart:input_type -> moment_api.CreateStandartRequest
	85,  // 138: moment_api.FlangeService.UpdateStandart:input_type -> moment_api.UpdateStandartRequest
	86,  // 139: moment_api.FlangeService.DeleteStandart:input_type -> moment_api.DeleteStandartRequest
	92,  // 140: moment_api.FlangeService.CreateFlangeSize:input_type -> moment_api.CreateFlangeSizeRequest
	93,  // 141: moment_api.FlangeService.CreateFlangeSizes:input_type -> moment_api.CreateFlangeSizesRequest
	94,  // 142: moment_api.FlangeService.UpdateFlangeSize:input_type -> moment_api.UpdateFlangeSizeRequest
	95,  // 143: moment_api.FlangeService.DeleteFlangeSize:input_type -> moment_api.DeleteFlangeSizeRequest
	96,  // 144: moment_api.FlangeService.GetBasisFlangeSize:input_type -> moment_api.GetBasisFlangeSizeRequest
	99,  // 145: moment_api.FlangeService.GetFlangeSize:input_type -> moment_api.GetFullFlangeSizeRequest
	108, // 146: moment_api.CalcFlangeService.CalculateFlange:input_type -> moment_api.CalcFlangeRequest
	122, // 147: moment_api.CalcCapService.CalculateCap:input_type -> moment_api.CalcCapRequest
	125, // 148: moment_api.ReadService.GetFlange:input_type -> moment_api.GetFlangeRequest
	12,  // 149: moment_api.PingService.Ping:output_type -> moment_api.PingResponse
	21,  // 150: moment_api.MaterialsService.GetMaterials:output_type -> moment_api.MaterialsResponse
	24,  // 151: moment_api.MaterialsService.GetMaterialsData:output_type -> moment_api.MaterialsDataResponse
	22,  // 152: moment_api.MaterialsService.GetMaterialsWithIsEmpty:output_type -> moment_api.MaterialsWithIsEmptyResponse
	13,  // 153: moment_api.MaterialsService.CreateMaterial:output_type -> moment_api.IdResponse
	14,  // 154: moment_api.MaterialsService.UpdateMaterial:output_type -> moment_api.Response
	14,  // 155: moment_api.MaterialsService.DeleteMaterial:output_type -> moment_api.Response
	14,  // 156: moment_api.MaterialsService.CreateVoltage:output_type -> moment_api.Response
	14,  // 157: moment_api.MaterialsService.UpdateVoltage:output_type -> moment_api.Response
	14,  // 158: moment_api.MaterialsService.DeleteVoltage:output_type -> moment_api.Response
	14,  // 159: moment_api.MaterialsService.CreateElasticity:output_type -> moment_api.Response
	14,  // 160: moment_api.MaterialsService.UpdateElasticity:output_type -> moment_api.Response
	14,  // 161: moment_api.MaterialsService.DeleteElasticity:output_type -> moment_api.Response
	14,  // 162: moment_api.MaterialsService.CreateAlpha:output_type -> moment_api.Response
	14,  // 163: moment_api.MaterialsService.UpdateAlpha:output_type -> moment_api.Response
	14,  // 164: moment_api.MaterialsService.DeleteAlpha:output_type -> moment_api.Response
	69,  // 165: moment_api.GasketService.GetFullData:output_type -> moment_api.FullDataResponse
	43,  // 166: moment_api.GasketService.GetGasket:output_type -> moment_api.GasketResponse
	44,  // 167: moment_api.GasketService.GetGasketWithThick:output_type -> moment_api.GasketWithThickResponse
	13,  // 168: moment_api.GasketService.CreateGasket:output_type -> moment_api.IdResponse
	14,  // 169: moment_api.GasketService.UpdateGasket:output_type -> moment_api.Response
	14,  // 170: moment_api.GasketService.DeleteGasket:output_type -> moment_api.Response
	50,  // 171: moment_api.GasketService.GetGasketType:output_type -> moment_api.GasketTypeResponse
	13,  // 172: moment_api.GasketService.CreateGasketType:output_type -> moment_api.IdResponse
	14,  // 173: moment_api.GasketService.UpdateGasketType:output_type -> moment_api.Response
	14,  // 174: moment_api.GasketService.DeleteGasketType:output_type -> moment_api.Response
	56,  // 175: moment_api.GasketService.GetEnv:output_type -> moment_api.EnvResponse
	13,  // 176: moment_api.GasketService.CreateEnv:output_type -> moment_api.IdResponse
	14,  // 177: moment_api.GasketService.UpdateEnv:output_type -> moment_api.Response
	14,  // 178: moment_api.GasketService.DeleteEnv:output_type -> moment_api.Response
	14,  // 179: moment_api.GasketService.CreateManyEnvData:output_type -> moment_api.Response
	14,  // 180: moment_api.GasketService.CreateEnvData:output_type -> moment_api.Response
	14,  // 181: moment_api.GasketService.UpdateEnvData:output_type -> moment_api.Response
	14,  // 182: moment_api.GasketService.DeleteEnvData:output_type -> moment_api.Response
	14,  // 183: moment_api.GasketService.CreateManyGasketData:output_type -> moment_api.Response
	14,  // 184: moment_api.GasketService.CreateGasketData:output_type -> moment_api.Response
	14,  // 185: moment_api.GasketService.UpdateGasketTypeId:output_type -> moment_api.Response
	14,  // 186: moment_api.GasketService.UpdateGasketData:output_type -> moment_api.Response
	14,  // 187: moment_api.GasketService.DeleteGasketData:output_type -> moment_api.Response
	76,  // 188: moment_api.FlangeService.GetBolts:output_type -> moment_api.BoltsResponse
	76,  // 189: moment_api.FlangeService.GetAllBolts:output_type -> moment_api.BoltsResponse
	14,  // 190: moment_api.FlangeService.CreateBolt:output_type -> moment_api.Response
	14,  // 191: moment_api.FlangeService.CreateBolts:output_type -> moment_api.Response
	14,  // 192: moment_api.FlangeService.UpdateBolt:output_type -> moment_api.Response
	14,  // 193: moment_api.FlangeService.DeleteBolt:output_type -> moment_api.Response
	82,  // 194: moment_api.FlangeService.GetTypeFlange:output_type -> moment_api.TypeFlangeResponse
	13,  // 195: moment_api.FlangeService.CreateTypeFlange:output_type -> moment_api.IdResponse
	14,  // 196: moment_api.FlangeService.UpdateTypeFlange:output_type -> moment_api.Response
	14,  // 197: moment_api.FlangeService.DeleteTypeFlange:output_type -> moment_api.Response
	89,  // 198: moment_api.FlangeService.GetStandarts:output_type -> moment_api.StandartsResponse
	90,  // 199: moment_api.FlangeService.GetStandartsWithSize:output_type -> moment_api.StandartsWithSizeResponse
	13,  // 200: moment_api.FlangeService.CreateStandart:output_type -> moment_api.IdResponse
	14,  // 201: moment_api.FlangeService.UpdateStandart:output_type -> moment_api.Response
	14,  // 202: moment_api.FlangeService.DeleteStandart:output_type -> moment_api.Response
	14,  // 203: moment_api.FlangeService.CreateFlangeSize:output_type -> moment_api.Response
	14,  // 204: moment_api.FlangeService.CreateFlangeSizes:output_type -> moment_api.Response
	14,  // 205: moment_api.FlangeService.UpdateFlangeSize:output_type -> moment_api.Response
	14,  // 206: moment_api.FlangeService.DeleteFlangeSize:output_type -> moment_api.Response
	98,  // 207: moment_api.FlangeService.GetBasisFlangeSize:output_type -> moment_api.BasisFlangeSizeResponse
	101, // 208: moment_api.FlangeService.GetFlangeSize:output_type -> moment_api.FullFlangeSizeResponse
	120, // 209: moment_api.CalcFlangeService.CalculateFlange:output_type -> moment_api.FlangeResponse
	124, // 210: moment_api.CalcCapService.CalculateCap:output_type -> moment_api.CapResponse
	126, // 211: moment_api.ReadService.GetFlange:output_type -> moment_api.GetFlangeResponse
