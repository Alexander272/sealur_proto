...
var file_moment_api_moment_proto_rawDesc = []byte{
	...
	0x46, 0x6c, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x57,
...
var file_moment_api_moment_proto_msgTypes = make([]protoimpl.MessageInfo, 123)
var file_moment_api_moment_proto_goTypes = []interface{}{
	...
	(*CreateBoltsRequest)(nil),               // 67: moment_api.CreateBoltsRequest
	(*UpdateBoltRequest)(nil),                // 68: moment_api.UpdateBoltRequest
	(*DeleteBoltRequest)(nil),                // 69: moment_api.DeleteBoltRequest
	(*Bolt)(nil),                             // 70: moment_api.Bolt
	(*BoltsResponse)(nil),                    // 71: moment_api.BoltsResponse
	(*GetTypeFlangeRequest)(nil),             // 72: moment_api.GetTypeFlangeRequest
	(*CreateTypeFlangeRequest)(nil),          // 73: moment_api.CreateTypeFlangeRequest
	(*UpdateTypeFlangeRequest)(nil),          // 74: moment_api.UpdateTypeFlangeRequest
	(*DeleteTypeFlangeRequest)(nil),          // 75: moment_api.DeleteTypeFlangeRequest
	(*TypeFlange)(nil),                       // 76: moment_api.TypeFlange
	(*TypeFlangeResponse)(nil),               // 77: moment_api.TypeFlangeResponse
	(*GetStandartsRequest)(nil),              // 78: moment_api.GetStandartsRequest
	(*CreateStandartRequest)(nil),            // 79: moment_api.CreateStandartRequest
	(*UpdateStandartRequest)(nil),            // 80: moment_api.UpdateStandartRequest
	(*DeleteStandartRequest)(nil),            // 81: moment_api.DeleteStandartRequest
	(*StandartWithSize)(nil),                 // 82: moment_api.StandartWithSize
	(*Standart)(nil),                         // 83: moment_api.Standart
	(*StandartsResponse)(nil),                // 84: moment_api.StandartsResponse
	(*StandartsWithSizeResponse)(nil),        // 85: moment_api.StandartsWithSizeResponse
	(*GetFlangeSizeRequest)(nil),             // 86: moment_api.GetFlangeSizeRequest
	(*CreateFlangeSizeRequest)(nil),          // 87: moment_api.CreateFlangeSizeRequest
	(*CreateFlangeSizesRequest)(nil),         // 88: moment_api.CreateFlangeSizesRequest
	(*UpdateFlangeSizeRequest)(nil),          // 89: moment_api.UpdateFlangeSizeRequest
	(*DeleteFlangeSizeRequest)(nil),          // 90: moment_api.DeleteFlangeSizeRequest
	(*GetBasisFlangeSizeRequest)(nil),        // 91: moment_api.GetBasisFlangeSizeRequest
	(*BasisFlangeSize)(nil),                  // 92: moment_api.BasisFlangeSize
	(*BasisFlangeSizeResponse)(nil),          // 93: moment_api.BasisFlangeSizeResponse
	(*GetFullFlangeSizeRequest)(nil),         // 94: moment_api.GetFullFlangeSizeRequest
	(*FullFlangeSize)(nil),                   // 95: moment_api.FullFlangeSize
	(*FullFlangeSizeResponse)(nil),           // 96: moment_api.FullFlangeSizeResponse
	(*MaterialData)(nil),                     // 97: moment_api.MaterialData
	(*FlangeData)(nil),                       // 98: moment_api.FlangeData
	(*BoltData)(nil),                         // 99: moment_api.BoltData
	(*WasherData)(nil),                       // 100: moment_api.WasherData
	(*GasketData)(nil),                       // 101: moment_api.GasketData
	(*EmbedData)(nil),                        // 102: moment_api.EmbedData
	(*CalcFlangeRequest)(nil),                // 103: moment_api.CalcFlangeRequest
	(*DataResult)(nil),                       // 104: moment_api.DataResult
	(*FlangeResult)(nil),                     // 105: moment_api.FlangeResult
	(*BoltResult)(nil),                       // 106: moment_api.BoltResult
	(*GasketResult)(nil),                     // 107: moment_api.GasketResult
	(*EmbedResult)(nil),                      // 108: moment_api.EmbedResult
	(*WasherResult)(nil),                     // 109: moment_api.WasherResult
	(*StrengthResult)(nil),                   // 110: moment_api.StrengthResult
	(*CalcMomentStrength)(nil),               // 111: moment_api.CalcMomentStrength
	(*CalcMomentBasis)(nil),                  // 112: moment_api.CalcMomentBasis
	(*CalculatedFlange)(nil),                 // 113: moment_api.CalculatedFlange
	(*CalcFormulas)(nil),                     // 114: moment_api.CalcFormulas
	(*FlangeResponse)(nil),                   // 115: moment_api.FlangeResponse
	(*GetFlangeRequest)(nil),                 // 116: moment_api.GetFlangeRequest
	(*GetFlangeResponse)(nil),                // 117: moment_api.GetFlangeResponse
	(*MaterialsDataResponse_Voltage)(nil),    // 118: moment_api.MaterialsDataResponse.Voltage
	(*MaterialsDataResponse_Elasticity)(nil), // 119: moment_api.MaterialsDataResponse.Elasticity
	(*MaterialsDataResponse_Alpha)(nil),      // 120: moment_api.MaterialsDataResponse.Alpha
	(*CreateManyEnvDataRequest_Data)(nil),    // 121: moment_api.CreateManyEnvDataRequest.Data
	(*CreateManyGasketDataRequest_Data)(nil), // 122: moment_api.CreateManyGasketDataRequest.Data
	(*FlangeData_Size)(nil),                  // 123: moment_api.FlangeData.Size
	(*GasketData_Data)(nil),                  // 124: moment_api.GasketData.Data
	(*CalcFormulas_StrengthF)(nil),           // 125: moment_api.CalcFormulas.StrengthF
	(*CalcFormulas_Flange)(nil),              // 126: moment_api.CalcFormulas.Flange
	(*CalcFormulas_Strength)(nil),            // 127: moment_api.CalcFormulas.Strength
	(*CalcFormulas_Basis)(nil),               // 128: moment_api.CalcFormulas.Basis
}
var file_moment_api_moment_proto_depIdxs = []int32{
	...
	118, // 2: moment_api.MaterialsDataResponse.voltage:type_name -> moment_api.MaterialsDataResponse.Voltage
	119, // 3: moment_api.MaterialsDataResponse.elasticity:type_name -> moment_api.MaterialsDataResponse.Elasticity
	120, // 4: moment_api.MaterialsDataResponse.alpha:type_name -> moment_api.MaterialsDataResponse.Alpha
	...
	121, // 12: moment_api.CreateManyEnvDataRequest.data:type_name -> moment_api.CreateManyEnvDataRequest.Data
	122, // 13: moment_api.CreateManyGasketDataRequest.data:type_name -> moment_api.CreateManyGasketDataRequest.Data
	...
	66,  // 18: moment_api.CreateBoltsRequest.bolts:type_name -> moment_api.CreateBoltRequest
	70,  // 19: moment_api.BoltsResponse.bolts:type_name -> moment_api.Bolt
	76,  // 20: moment_api.TypeFlangeResponse.typeFlanges:type_name -> moment_api.TypeFlange
	93,  // 21: moment_api.StandartWithSize.sizes:type_name -> moment_api.BasisFlangeSizeResponse
	83,  // 22: moment_api.StandartsResponse.standarts:type_name -> moment_api.Standart
	82,  // 23: moment_api.StandartsWithSizeResponse.standarts:type_name -> moment_api.StandartWithSize
	87,  // 24: moment_api.CreateFlangeSizesRequest.sizes:type_name -> moment_api.CreateFlangeSizeRequest
	92,  // 25: moment_api.BasisFlangeSizeResponse.sizeRow1:type_name -> moment_api.BasisFlangeSize
	92,  // 26: moment_api.BasisFlangeSizeResponse.sizeRow2:type_name -> moment_api.BasisFlangeSize
	95,  // 27: moment_api.FullFlangeSizeResponse.sizeRow1:type_name -> moment_api.FullFlangeSize
	95,  // 28: moment_api.FullFlangeSizeResponse.sizeRow2:type_name -> moment_api.FullFlangeSize
	0,   // 29: moment_api.FlangeData.type:type_name -> moment_api.FlangeData.Type
	123, // 30: moment_api.FlangeData.size:type_name -> moment_api.FlangeData.Size
	97,  // 31: moment_api.FlangeData.material:type_name -> moment_api.MaterialData
	97,  // 32: moment_api.FlangeData.ringMaterial:type_name -> moment_api.MaterialData
	97,  // 33: moment_api.BoltData.material:type_name -> moment_api.MaterialData
	97,  // 34: moment_api.WasherData.material:type_name -> moment_api.MaterialData
	124, // 35: moment_api.GasketData.data:type_name -> moment_api.GasketData.Data
	97,  // 36: moment_api.EmbedData.material:type_name -> moment_api.MaterialData
	...
	98,  // 41: moment_api.CalcFlangeRequest.flangesData:type_name -> moment_api.FlangeData
	99,  // 42: moment_api.CalcFlangeRequest.bolts:type_name -> moment_api.BoltData
	101, // 43: moment_api.CalcFlangeRequest.gasket:type_name -> moment_api.GasketData
	102, // 44: moment_api.CalcFlangeRequest.embed:type_name -> moment_api.EmbedData
	100, // 45: moment_api.CalcFlangeRequest.washer:type_name -> moment_api.WasherData
	110, // 46: moment_api.CalcMomentStrength.strength:type_name -> moment_api.StrengthResult
	111, // 47: moment_api.CalculatedFlange.strength:type_name -> moment_api.CalcMomentStrength
	112, // 48: moment_api.CalculatedFlange.basis:type_name -> moment_api.CalcMomentBasis
	128, // 49: moment_api.CalcFormulas.basis:type_name -> moment_api.CalcFormulas.Basis
	127, // 50: moment_api.CalcFormulas.strength:type_name -> moment_api.CalcFormulas.Strength
	105, // 51: moment_api.FlangeResponse.flanges:type_name -> moment_api.FlangeResult
	106, // 52: moment_api.FlangeResponse.bolt:type_name -> moment_api.BoltResult
	107, // 53: moment_api.FlangeResponse.gasket:type_name -> moment_api.GasketResult
	108, // 54: moment_api.FlangeResponse.embed:type_name -> moment_api.EmbedResult
	113, // 55: moment_api.FlangeResponse.calc:type_name -> moment_api.CalculatedFlange
	114, // 56: moment_api.FlangeResponse.formulas:type_name -> moment_api.CalcFormulas
	104, // 57: moment_api.FlangeResponse.data:type_name -> moment_api.DataResult
	109, // 58: moment_api.FlangeResponse.washers:type_name -> moment_api.WasherResult
	76,  // 59: moment_api.GetFlangeResponse.typeFlange:type_name -> moment_api.TypeFlange
	82,  // 60: moment_api.GetFlangeResponse.standarts:type_name -> moment_api.StandartWithSize
	33,  // 61: moment_api.GetFlangeResponse.gaskets:type_name -> moment_api.GasketWithThick
	46,  // 62: moment_api.GetFlangeResponse.env:type_name -> moment_api.Env
	10,  // 63: moment_api.GetFlangeResponse.materials:type_name -> moment_api.Material
	1,   // 64: moment_api.GasketData.Data.type:type_name -> moment_api.GasketData.Type
	125, // 65: moment_api.CalcFormulas.Strength.strength:type_name -> moment_api.CalcFormulas.StrengthF
	126, // 66: moment_api.CalcFormulas.Strength.flange:type_name -> moment_api.CalcFormulas.Flange
	6,   // 67: moment_api.PingService.Ping:input_type -> moment_api.PingRequest
	12,  // 68: moment_api.MaterialsService.GetMaterials:input_type -> moment_api.GetMaterialsRequest
	18,  // 69: moment_api.MaterialsService.GetMaterialsData:input_type -> moment_api.GetMaterialsDataRequest
	12,  // 70: moment_api.MaterialsService.GetMaterialsWithIsEmpty:input_type -> moment_api.GetMaterialsRequest
	13,  // 71: moment_api.MaterialsService.CreateMaterial:input_type -> moment_api.CreateMaterialRequest
	14,  // 72: moment_api.MaterialsService.UpdateMaterial:input_type -> moment_api.UpdateMaterialRequest
	15,  // 73: moment_api.MaterialsService.DeleteMaterial:input_type -> moment_api.DeleteMaterialRequest
	21,  // 74: moment_api.MaterialsService.CreateVoltage:input_type -> moment_api.CreateVoltageRequest
	22,  // 75: moment_api.MaterialsService.UpdateVoltage:input_type -> moment_api.UpdateVoltageRequest
	23,  // 76: moment_api.MaterialsService.DeleteVoltage:input_type -> moment_api.DeleteVoltageRequest
	25,  // 77: moment_api.MaterialsService.CreateElasticity:input_type -> moment_api.CreateElasticityRequest
	26,  // 78: moment_api.MaterialsService.UpdateElasticity:input_type -> moment_api.UpdateElasticityRequest
	27,  // 79: moment_api.MaterialsService.DeleteElasticity:input_type -> moment_api.DeleteElasticityRequest
	29,  // 80: moment_api.MaterialsService.CreateAlpha:input_type -> moment_api.CreateAlphaRequest
	30,  // 81: moment_api.MaterialsService.UpdateAlpha:input_type -> moment_api.UpdateAlphaRequest
	31,  // 82: moment_api.MaterialsService.DeleteAlpha:input_type -> moment_api.DeleteAlphaRequest
	63,  // 83: moment_api.GasketService.GetFullData:input_type -> moment_api.GetFullDataRequest
	34,  // 84: moment_api.GasketService.GetGasket:input_type -> moment_api.GetGasketRequest
	34,  // 85: moment_api.GasketService.GetGasketWithThick:input_type -> moment_api.GetGasketRequest
	35,  // 86: moment_api.GasketService.CreateGasket:input_type -> moment_api.CreateGasketRequest
	36,  // 87: moment_api.GasketService.UpdateGasket:input_type -> moment_api.UpdateGasketRequest
	37,  // 88: moment_api.GasketService.DeleteGasket:input_type -> moment_api.DeleteGasketRequest
	41,  // 89: moment_api.GasketService.GetGasketType:input_type -> moment_api.GetGasketTypeRequest
	42,  // 90: moment_api.GasketService.CreateGasketType:input_type -> moment_api.CreateGasketTypeRequest
	43,  // 91: moment_api.GasketService.UpdateGasketType:input_type -> moment_api.UpdateGasketTypeRequest
	44,  // 92: moment_api.GasketService.DeleteGasketType:input_type -> moment_api.DeleteGasketTypeRequest
	47,  // 93: moment_api.GasketService.GetEnv:input_type -> moment_api.GetEnvRequest
	48,  // 94: moment_api.GasketService.CreateEnv:input_type -> moment_api.CreateEnvRequest
	49,  // 95: moment_api.GasketService.UpdateEnv:input_type -> moment_api.UpdateEnvRequest
	50,  // 96: moment_api.GasketService.DeleteEnv:input_type -> moment_api.DeleteEnvRequest
	52,  // 97: moment_api.GasketService.CreateManyEnvData:input_type -> moment_api.CreateManyEnvDataRequest
	53,  // 98: moment_api.GasketService.CreateEnvData:input_type -> moment_api.CreateEnvDataRequest
	54,  // 99: moment_api.GasketService.UpdateEnvData:input_type -> moment_api.UpdateEnvDataRequest
	55,  // 100: moment_api.GasketService.DeleteEnvData:input_type -> moment_api.DeleteEnvDataRequest
	56,  // 101: moment_api.GasketService.CreateManyGasketData:input_type -> moment_api.CreateManyGasketDataRequest
	57,  // 102: moment_api.GasketService.CreateGasketData:input_type -> moment_api.CreateGasketDataRequest
	59,  // 103: moment_api.GasketService.UpdateGasketTypeId:input_type -> moment_api.UpdateGasketTypeIdRequest
	58,  // 104: moment_api.GasketService.UpdateGasketData:input_type -> moment_api.UpdateGasketDataRequest
	60,  // 105: moment_api.GasketService.DeleteGasketData:input_type -> moment_api.DeleteGasketDataRequest
	65,  // 106: moment_api.FlangeService.GetBolts:input_type -> moment_api.GetBoltsRequest
	65,  // 107: moment_api.FlangeService.GetAllBolts:input_type -> moment_api.GetBoltsRequest
	66,  // 108: moment_api.FlangeService.CreateBolt:input_type -> moment_api.CreateBoltRequest
	67,  // 109: moment_api.FlangeService.CreateBolts:input_type -> moment_api.CreateBoltsRequest
	68,  // 110: moment_api.FlangeService.UpdateBolt:input_type -> moment_api.UpdateBoltRequest
	69,  // 111: moment_api.FlangeService.DeleteBolt:input_type -> moment_api.DeleteBoltRequest
	72,  // 112: moment_api.FlangeService.GetTypeFlange:input_type -> moment_api.GetTypeFlangeRequest
	73,  // 113: moment_api.FlangeService.CreateTypeFlange:input_type -> moment_api.CreateTypeFlangeRequest
	74,  // 114: moment_api.FlangeService.UpdateTypeFlange:input_type -> moment_api.UpdateTypeFlangeRequest
	75,  // 115: moment_api.FlangeService.DeleteTypeFlange:input_type -> moment_api.DeleteTypeFlangeRequest
	78,  // 116: moment_api.FlangeService.GetStandarts:input_type -> moment_api.GetStandartsRequest
	78,  // 117: moment_api.FlangeService.GetStandartsWithSize:input_type -> moment_api.GetStandartsRequest
	79,  // 118: moment_api.FlangeService.CreateStandart:input_type -> moment_api.CreateStandartRequest
	80,  // 119: moment_api.FlangeService.UpdateStandart:input_type -> moment_api.UpdateStandartRequest
	81,  // 120: moment_api.FlangeService.DeleteStandart:input_type -> moment_api.DeleteStandartRequest
	87,  // 121: moment_api.FlangeService.CreateFlangeSize:input_type -> moment_api.CreateFlangeSizeRequest
	88,  // 122: moment_api.FlangeService.CreateFlangeSizes:input_type -> moment_api.CreateFlangeSizesRequest
	89,  // 123: moment_api.FlangeService.UpdateFlangeSize:input_type -> moment_api.UpdateFlangeSizeRequest
	90,  // 124: moment_api.FlangeService.DeleteFlangeSize:input_type -> moment_api.DeleteFlangeSizeRequest
	91,  // 125: moment_api.FlangeService.GetBasisFlangeSize:input_type -> moment_api.GetBasisFlangeSizeRequest
	94,  // 126: moment_api.FlangeService.GetFlangeSize:input_type -> moment_api.GetFullFlangeSizeRequest
	103, // 127: moment_api.CalcFlangeService.CalculateFlange:input_type -> moment_api.CalcFlangeRequest
	116, // 128: moment_api.ReadService.GetFlange:input_type -> moment_api.GetFlangeRequest
	7,   // 129: moment_api.PingService.Ping:output_type -> moment_api.PingResponse
	16,  // 130: moment_api.MaterialsService.GetMaterials:output_type -> moment_api.MaterialsResponse
	19,  // 131: moment_api.MaterialsService.GetMaterialsData:output_type -> moment_api.MaterialsDataResponse
	17,  // 132: moment_api.MaterialsService.GetMaterialsWithIsEmpty:output_type -> moment_api.MaterialsWithIsEmptyResponse
	8,   // 133: moment_api.MaterialsService.CreateMaterial:output_type -> moment_api.IdResponse
	9,   // 134: moment_api.MaterialsService.UpdateMaterial:output_type -> moment_api.Response
	9,   // 135: moment_api.MaterialsService.DeleteMaterial:output_type -> moment_api.Response
	9,   // 136: moment_api.MaterialsService.CreateVoltage:output_type -> moment_api.Response
	9,   // 137: moment_api.MaterialsService.UpdateVoltage:output_type -> moment_api.Response
	9,   // 138: moment_api.MaterialsService.DeleteVoltage:output_type -> moment_api.Response
	9,   // 139: moment_api.MaterialsService.CreateElasticity:output_type -> moment_api.Response
	9,   // 140: moment_api.MaterialsService.UpdateElasticity:output_type -> moment_api.Response
	9,   // 141: moment_api.MaterialsService.DeleteElasticity:output_type -> moment_api.Response
	9,   // 142: moment_api.MaterialsService.CreateAlpha:output_type -> moment_api.Response
	9,   // 143: moment_api.MaterialsService.UpdateAlpha:output_type -> moment_api.Response
	9,   // 144: moment_api.MaterialsService.DeleteAlpha:output_type -> moment_api.Response
	64,  // 145: moment_api.GasketService.GetFullData:output_type -> moment_api.FullDataResponse
	38,  // 146: moment_api.GasketService.GetGasket:output_type -> moment_api.GasketResponse
	39,  // 147: moment_api.GasketService.GetGasketWithThick:output_type -> moment_api.GasketWithThickResponse
	8,   // 148: moment_api.GasketService.CreateGasket:output_type -> moment_api.IdResponse
	9,   // 149: moment_api.GasketService.UpdateGasket:output_type -> moment_api.Response
	9,   // 150: moment_api.GasketService.DeleteGasket:output_type -> moment_api.Response
	45,  // 151: moment_api.GasketService.GetGasketType:output_type -> moment_api.GasketTypeResponse
	8,   // 152: moment_api.GasketService.CreateGasketType:output_type -> moment_api.IdResponse
	9,   // 153: moment_api.GasketService.UpdateGasketType:output_type -> moment_api.Response
	9,   // 154: moment_api.GasketService.DeleteGasketType:output_type -> moment_api.Response
	51,  // 155: moment_api.GasketService.GetEnv:output_type -> moment_api.EnvResponse
	8,   // 156: moment_api.GasketService.CreateEnv:output_type -> moment_api.IdResponse
	9,   // 157: moment_api.GasketService.UpdateEnv:output_type -> moment_api.Response
	9,   // 158: moment_api.GasketService.DeleteEnv:output_type -> moment_api.Response
	9,   // 159: moment_api.GasketService.CreateManyEnvData:output_type -> moment_api.Response
	9,   // 160: moment_api.GasketService.CreateEnvData:output_type -> moment_api.Response
	9,   // 161: moment_api.GasketService.UpdateEnvData:output_type -> moment_api.Response
	9,   // 162: moment_api.GasketService.DeleteEnvData:output_type -> moment_api.Response
	9,   // 163: moment_api.GasketService.CreateManyGasketData:output_type -> moment_api.Response
	9,   // 164: moment_api.GasketService.CreateGasketData:output_type -> moment_api.Response
	9,   // 165: moment_api.GasketService.UpdateGasketTypeId:output_type -> moment_api.Response
	9,   // 166: moment_api.GasketService.UpdateGasketData:output_type -> moment_api.Response
	9,   // 167: moment_api.GasketService.DeleteGasketData:output_type -> moment_api.Response
	71,  // 168: moment_api.FlangeService.GetBolts:output_type -> moment_api.BoltsResponse
	71,  // 169: moment_api.FlangeService.GetAllBolts:output_type -> moment_api.BoltsResponse
	9,   // 170: moment_api.FlangeService.CreateBolt:output_type -> moment_api.Response
	9,   // 171: moment_api.FlangeService.CreateBolts:output_type -> moment_api.Response
	9,   // 172: moment_api.FlangeService.UpdateBolt:output_type -> moment_api.Response
	9,   // 173: moment_api.FlangeService.DeleteBolt:output_type -> moment_api.Response
	77,  // 174: moment_api.FlangeService.GetTypeFlange:output_type -> moment_api.TypeFlangeResponse
	8,   // 175: moment_api.FlangeService.CreateTypeFlange:output_type -> moment_api.IdResponse
	9,   // 176: moment_api.FlangeService.UpdateTypeFlange:output_type -> moment_api.Response
	9,   // 177: moment_api.FlangeService.DeleteTypeFlange:output_type -> moment_api.Response
	84,  // 178: moment_api.FlangeService.GetStandarts:output_type -> moment_api.StandartsResponse
	85,  // 179: moment_api.FlangeService.GetStandartsWithSize:output_type -> moment_api.StandartsWithSizeResponse
	8,   // 180: moment_api.FlangeService.CreateStandart:output_type -> moment_api.IdResponse
	9,   // 181: moment_api.FlangeService.UpdateStandart:output_type -> moment_api.Response
	9,   // 182: moment_api.FlangeService.DeleteStandart:output_type -> moment_api.Response
	9,   // 183: moment_api.FlangeService.CreateFlangeSize:output_type -> moment_api.Response
	9,   // 184: moment_api.FlangeService.CreateFlangeSizes:output_type -> moment_api.Response
	9,   // 185: moment_api.FlangeService.UpdateFlangeSize:output_type -> moment_api.Response
	9,   // 186: moment_api.FlangeService.DeleteFlangeSize:output_type -> moment_api.Response
	93,  // 187: moment_api.FlangeService.GetBasisFlangeSize:output_type -> moment_api.BasisFlangeSizeResponse
	96,  // 188: moment_api.FlangeService.GetFlangeSize:output_type -> moment_api.FullFlangeSizeResponse
	115, // 189: moment_api.CalcFlangeService.CalculateFlange:output_type -> moment_api.FlangeResponse
	117, // 190: moment_api.ReadService.GetFlange:output_type -> moment_api.GetFlangeResponse
	129, // [129:191] is the sub-list for method output_type
	67,  // [67:129] is the sub-list for method input_type
