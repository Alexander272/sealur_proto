...
const (
	UserService_Get_FullMethodName             = "/user_api.UserService/Get"
	UserService_GetFull_FullMethodName         = "/user_api.UserService/GetFull"
	UserService_GetByEmail_FullMethodName      = "/user_api.UserService/GetByEmail"
	UserService_GetByParam_FullMethodName      = "/user_api.UserService/GetByParam"
	UserService_GetAll_FullMethodName          = "/user_api.UserService/GetAll"
	UserService_GetNew_FullMethodName          = "/user_api.UserService/GetNew"
	UserService_GetManagers_FullMethodName     = "/user_api.UserService/GetManagers"
	UserService_GetManagerEmail_FullMethodName = "/user_api.UserService/GetManagerEmail"
	UserService_GetAnalytics_FullMethodName    = "/user_api.UserService/GetAnalytics"
	UserService_Create_FullMethodName          = "/user_api.UserService/Create"
	UserService_Confirm_FullMethodName         = "/user_api.UserService/Confirm"
	UserService_Visit_FullMethodName           = "/user_api.UserService/Visit"
	UserService_Update_FullMethodName          = "/user_api.UserService/Update"
	UserService_SetManager_FullMethodName      = "/user_api.UserService/SetManager"
	UserService_Delete_FullMethodName          = "/user_api.UserService/Delete"
)
...
func (c *userServiceClient) GetFull(ctx context.Context, in *GetUser, opts ...grpc.CallOption) (*user_model.FullUser, error) {
	...
	err := c.cc.Invoke(ctx, UserService_GetFull_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetByParam(ctx context.Context, in *GetUsersByParam, opts ...grpc.CallOption) (*AnalyticsUsers, error) {
	...
	err := c.cc.Invoke(ctx, UserService_GetByParam_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetNew(ctx context.Context, in *GetNewUser, opts ...grpc.CallOption) (*Users, error) {
	out := new(Users)
	err := c.cc.Invoke(ctx, UserService_GetNew_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetManagers(ctx context.Context, in *GetNewUser, opts ...grpc.CallOption) (*Users, error) {
	out := new(Users)
	err := c.cc.Invoke(ctx, UserService_GetManagers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetManagerEmail(ctx context.Context, in *GetUser, opts ...grpc.CallOption) (*Manager, error) {
	out := new(Manager)
	err := c.cc.Invoke(ctx, UserService_GetManagerEmail_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetAnalytics(ctx context.Context, in *GetUserAnalytics, opts ...grpc.CallOption) (*Analytics, error) {
	out := new(Analytics)
	err := c.cc.Invoke(ctx, UserService_GetAnalytics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) Visit(ctx context.Context, in *GetUser, opts ...grpc.CallOption) (*response_model.Response, error) {
	...
	err := c.cc.Invoke(ctx, UserService_Visit_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) SetManager(ctx context.Context, in *UserManager, opts ...grpc.CallOption) (*response_model.Response, error) {
	out := new(response_model.Response)
	err := c.cc.Invoke(ctx, UserService_SetManager_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_GetFull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetFull_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_GetByParam_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetByParam_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_GetNew_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetNew_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_GetManagers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetManagers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_GetManagerEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetManagerEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_Visit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_Visit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_SetManager_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_SetManager_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
