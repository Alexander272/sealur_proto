...
var file_user_user_api_proto_rawDesc = []byte{
	...
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x32, 0xb1, 0x04, 0x0a, 0x0b,
...
var file_user_user_api_proto_depIdxs = []int32{
	...
	9,  // 10: user_api.UserService.Confirm:input_type -> user_api.ConfirmUser
	6,  // 11: user_api.UserService.Update:input_type -> user_api.UpdateUser
	7,  // 12: user_api.UserService.SetManager:input_type -> user_api.UserManager
	8,  // 13: user_api.UserService.Delete:input_type -> user_api.DeleteUser
	14, // 14: user_api.UserService.Get:output_type -> user_model.User
	14, // 15: user_api.UserService.GetByEmail:output_type -> user_model.User
	11, // 16: user_api.UserService.GetAll:output_type -> user_api.Users
	11, // 17: user_api.UserService.GetNew:output_type -> user_api.Users
	12, // 18: user_api.UserService.GetManagerEmail:output_type -> user_api.Manager
	15, // 19: user_api.UserService.Create:output_type -> response_model.IdResponse
	14, // 20: user_api.UserService.Confirm:output_type -> user_model.User
	16, // 21: user_api.UserService.Update:output_type -> response_model.Response
	16, // 22: user_api.UserService.SetManager:output_type -> response_model.Response
	16, // 23: user_api.UserService.Delete:output_type -> response_model.Response
