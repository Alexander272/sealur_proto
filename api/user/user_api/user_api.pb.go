...
var file_user_user_api_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xec, 0x03, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72,
	...
	0x31, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x12, 0x11, 0x2e,
...
var file_user_user_api_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_user_user_api_proto_goTypes = []interface{}{
	...
	(*GetAllUser_Search)(nil),         // 11: user_api.GetAllUser.Search
	(*user_model.User)(nil),           // 12: user_model.User
...
var file_user_user_api_proto_depIdxs = []int32{
	11, // 0: user_api.GetAllUser.search:type_name -> user_api.GetAllUser.Search
	12, // 1: user_api.Users.users:type_name -> user_model.User
	0,  // 2: user_api.GetAllUser.Search.field:type_name -> user_api.GetAllUser.SearchField
	1,  // 3: user_api.UserService.Get:input_type -> user_api.GetUser
	2,  // 4: user_api.UserService.GetByEmail:input_type -> user_api.GetUserByEmail
	3,  // 5: user_api.UserService.GetAll:input_type -> user_api.GetAllUser
	4,  // 6: user_api.UserService.GetNew:input_type -> user_api.GetNewUser
	1,  // 7: user_api.UserService.GetManager:input_type -> user_api.GetUser
	5,  // 8: user_api.UserService.Create:input_type -> user_api.CreateUser
	8,  // 9: user_api.UserService.Confirm:input_type -> user_api.ConfirmUser
	6,  // 10: user_api.UserService.Update:input_type -> user_api.UpdateUser
	7,  // 11: user_api.UserService.Delete:input_type -> user_api.DeleteUser
	12, // 12: user_api.UserService.Get:output_type -> user_model.User
	12, // 13: user_api.UserService.GetByEmail:output_type -> user_model.User
	10, // 14: user_api.UserService.GetAll:output_type -> user_api.Users
	10, // 15: user_api.UserService.GetNew:output_type -> user_api.Users
	12, // 16: user_api.UserService.GetManager:output_type -> user_model.User
	13, // 17: user_api.UserService.Create:output_type -> response_model.IdResponse
	12, // 18: user_api.UserService.Confirm:output_type -> user_model.User
	14, // 19: user_api.UserService.Update:output_type -> response_model.Response
	14, // 20: user_api.UserService.Delete:output_type -> response_model.Response
