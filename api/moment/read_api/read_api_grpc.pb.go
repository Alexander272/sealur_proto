...
const (
	ReadService_GetFlange_FullMethodName     = "/read_api.ReadService/GetFlange"
	ReadService_GetFloat_FullMethodName      = "/read_api.ReadService/GetFloat"
	ReadService_GetDevCooling_FullMethodName = "/read_api.ReadService/GetDevCooling"
	ReadService_GetAVO_FullMethodName        = "/read_api.ReadService/GetAVO"
)
...
type ReadServiceClient interface {
	...
	GetAVO(ctx context.Context, in *GetAVORequest, opts ...grpc.CallOption) (*GetAVOResponse, error)
}
...
func (c *readServiceClient) GetFlange(ctx context.Context, in *GetFlangeRequest, opts ...grpc.CallOption) (*GetFlangeResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReadService_GetFlange_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *readServiceClient) GetFloat(ctx context.Context, in *GetFloatRequest, opts ...grpc.CallOption) (*GetFloatResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReadService_GetFloat_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *readServiceClient) GetDevCooling(ctx context.Context, in *GetDevCoolingtRequest, opts ...grpc.CallOption) (*GetDevCoolingResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReadService_GetDevCooling_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *readServiceClient) GetAVO(ctx context.Context, in *GetAVORequest, opts ...grpc.CallOption) (*GetAVOResponse, error) {
	out := new(GetAVOResponse)
	err := c.cc.Invoke(ctx, ReadService_GetAVO_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReadServiceServer interface {
	...
	GetAVO(context.Context, *GetAVORequest) (*GetAVOResponse, error)
...
func (UnimplementedReadServiceServer) GetAVO(context.Context, *GetAVORequest) (*GetAVOResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAVO not implemented")
}
...
func _ReadService_GetFlange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReadService_GetFlange_FullMethodName,
	}
...
func _ReadService_GetFloat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReadService_GetFloat_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReadService_GetDevCooling_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReadService_GetDevCooling_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReadService_GetAVO_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAVORequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReadServiceServer).GetAVO(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReadService_GetAVO_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReadServiceServer).GetAVO(ctx, req.(*GetAVORequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ReadService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAVO",
			Handler:    _ReadService_GetAVO_Handler,
		},
	},
