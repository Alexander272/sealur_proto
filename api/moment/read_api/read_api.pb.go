...
var file_moment_read_api_proto_rawDesc = []byte{
	...
	0x73, 0x32, 0x53, 0x0a, 0x0b, 0x52, 0x65, 0x61, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x44, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x46, 0x6c, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x1a, 0x2e,
	0x72, 0x65, 0x61, 0x64, 0x5f, 0x61, 0x70, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x46, 0x6c, 0x61, 0x6e,
	0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x72, 0x65, 0x61, 0x64,
	...
	0x70, 0x69, 0x2f, 0x6d, 0x6f, 0x6d, 0x65, 0x6e, 0x74, 0x2f, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x61,
...
var file_moment_read_api_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_moment_read_api_proto_goTypes = []interface{}{
	...
	(*flange_model.TypeFlange)(nil),       // 2: flange_model.TypeFlange
	(*flange_model.StandartWithSize)(nil), // 3: flange_model.StandartWithSize
	(*gasket_model.GasketWithThick)(nil),  // 4: gasket_model.GasketWithThick
	(*gasket_model.Env)(nil),              // 5: gasket_model.Env
	(*material_model.Material)(nil),       // 6: material_model.Material
}
var file_moment_read_api_proto_depIdxs = []int32{
	2, // 0: read_api.GetFlangeResponse.typeFlange:type_name -> flange_model.TypeFlange
	3, // 1: read_api.GetFlangeResponse.standarts:type_name -> flange_model.StandartWithSize
	4, // 2: read_api.GetFlangeResponse.gaskets:type_name -> gasket_model.GasketWithThick
	5, // 3: read_api.GetFlangeResponse.env:type_name -> gasket_model.Env
	6, // 4: read_api.GetFlangeResponse.materials:type_name -> material_model.Material
	0, // 5: read_api.ReadService.GetFlange:input_type -> read_api.GetFlangeRequest
	1, // 6: read_api.ReadService.GetFlange:output_type -> read_api.GetFlangeResponse
