...
const (
	FileService_Ping_FullMethodName          = "/file_api.FileService/Ping"
	FileService_Download_FullMethodName      = "/file_api.FileService/Download"
	FileService_GroupDownload_FullMethodName = "/file_api.FileService/GroupDownload"
	FileService_Upload_FullMethodName        = "/file_api.FileService/Upload"
	FileService_Copy_FullMethodName          = "/file_api.FileService/Copy"
	FileService_CopyGroup_FullMethodName     = "/file_api.FileService/CopyGroup"
	FileService_Delete_FullMethodName        = "/file_api.FileService/Delete"
	FileService_GroupDelete_FullMethodName   = "/file_api.FileService/GroupDelete"
)
...
func (c *fileServiceClient) GroupDownload(ctx context.Context, in *GroupDownloadRequest, opts ...grpc.CallOption) (FileService_GroupDownloadClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[1], FileService_GroupDownload_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *fileServiceClient) Copy(ctx context.Context, in *CopyFileRequest, opts ...grpc.CallOption) (*MessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, FileService_Copy_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileServiceClient) CopyGroup(ctx context.Context, in *CopyGroupRequest, opts ...grpc.CallOption) (*MessageResponse, error) {
	out := new(MessageResponse)
	err := c.cc.Invoke(ctx, FileService_CopyGroup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileServiceClient) GroupDelete(ctx context.Context, in *GroupDeleteRequest, opts ...grpc.CallOption) (*MessageResponse, error) {
	out := new(MessageResponse)
	err := c.cc.Invoke(ctx, FileService_GroupDelete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFileServiceServer) GroupDownload(*GroupDownloadRequest, FileService_GroupDownloadServer) error {
	return status.Errorf(codes.Unimplemented, "method GroupDownload not implemented")
}
func (UnimplementedFileServiceServer) Upload(FileService_UploadServer) error {
	return status.Errorf(codes.Unimplemented, "method Upload not implemented")
}
func (UnimplementedFileServiceServer) Copy(context.Context, *CopyFileRequest) (*MessageResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Copy not implemented")
}
func (UnimplementedFileServiceServer) CopyGroup(context.Context, *CopyGroupRequest) (*MessageResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CopyGroup not implemented")
}
func (UnimplementedFileServiceServer) Delete(context.Context, *FileDeleteRequest) (*MessageResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedFileServiceServer) GroupDelete(context.Context, *GroupDeleteRequest) (*MessageResponse, error) {
...
func _FileService_CopyGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileService_CopyGroup_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FileService_GroupDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileService_GroupDelete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "file_api.FileService",
